...
```
```{r, raca data prep}
raca_call<-reg_baseline(border, 30)
raca_data<-raca_call[[1]]
ecoregion<-raca_call[[2]]
...
stocks.inds <- c("total_c", "org_c", "inorg_c", "maoc", "poc") #these are the columns that can be turned into stocks (CHECK hard coding these in for now. Not sure if there's a better solution)
...
my_order <- c("SOC", "SIC", "MAOC", "POC", "BD", "pH", "Sand", "Silt", "Clay")
