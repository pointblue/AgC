...
cat("Note that your project included indicators that aren’t directly related to carbon dynamics. These indicators provide additional information about site dynamics but aren’t covered in the `r proj.protocol` handbook.  ")}
```
