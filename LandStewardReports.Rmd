...
dynamicmap.inds <- c("org_c", dynamicmap.inds[dynamicmap.inds != "org_c"]) #ensure SOC% always comes first; important for map rendering
...
#CHECK -- we need to do this differentyl
legends_names <- c(
  "org_c_stocks" = "SOC stocks (tons/acre)",
  "inorg_c_stoks" = "SIC stocks (tons/acre)",
  "maoc_stocks" = "MAOC stocks (tons/acre)",
  "poc_stocks" = "POC stocks (tons/acre)",
  "org_c" = "SOC %",
  "inorg_c" = "SIC %",
  "maoc" = "MAOC %",
  "poc" = "POC %",
  "bulk_density" = "BD (g/cm3)",
  "sand" = "Sand %",
  "silt" = "Silt %",
  "clay" = "Clay %",
  "ph" = "pH"
