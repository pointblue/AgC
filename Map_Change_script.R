...
if ("bulk_density" %in% proj.indicators.SSC.stocks && params$stocks==TRUE) {
...
#MOSTLY RIGHT BUT THERES AN NA LAYER THAT NEEDS INVESTIGATING -- probably due to removing N?
